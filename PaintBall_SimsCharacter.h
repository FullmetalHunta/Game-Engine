...
#include "PaintBall_SimsCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class APaintBall_SimsCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class APaintBall_SimsProjectile> ProjectileClass;
...
private:
	...
	//This allows for the shaders to work for the game.
