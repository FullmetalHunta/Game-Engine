...
class ULensDistortionBlueprintLibrary : public UBlueprintFunctionLibrary
{
	...
	*/
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Equal (FooCameraModel)", CompactNodeTitle = "==", Keywords = "== equal"), Category = "Foo | Lens Distortion")
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "NotEqual (FooCameraModel)", CompactNodeTitle = "!=", Keywords = "!= not equal"), Category = "Foo | Lens Distortion")
